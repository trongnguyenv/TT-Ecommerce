namespace TTEcommerce.Core.Infrastructure.Marten.Tests;
...
public class MartenQueryableStub<TResult> : List<TResult>, IMartenQueryable<TResult>
{
    ...
    public IMartenQueryable<TResult> Include<TInclude>(Expression<Func<TResult, object>> idSource,
        Action<TInclude> callback) where TInclude : notnull
    {
        throw new NotImplementedException();
    }

    public IMartenQueryable<TResult> Include<TInclude>(Expression<Func<TResult, object>> idSource, IList<TInclude> list)
        where TInclude : notnull
    {
        throw new NotImplementedException();
    }

    public IMartenQueryable<TResult> Include<TInclude, TKey>(Expression<Func<TResult, object>> idSource,
