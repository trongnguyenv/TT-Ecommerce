        ...
        IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(s =>
        {
            s.SwaggerDoc(swaggerSettings.Version, new OpenApiInfo
            {
                ...
                Contact = new OpenApiContact { Name = "Trong Nguyen", Email = "trongdk586@gmail.com" },
                License = new OpenApiLicense() { Name = "MIT", Url = new Uri("https://github.com/trongnguyenv/TT-Ecommerce/blob/main/LICENSE") }
            });
